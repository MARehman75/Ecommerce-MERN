  ...
  return (
    <>
      {items.length ?
        ...
        :
        <>
          <h1 className="text-4xl font-bold my-5 pt-3 tracking-tight text-gray-900">Nothing in cart</h1>
          <div className="mt-6">
            <Link
              to={'/'}
              className="flex items-center justify-center mx-12 rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
            >
              Continue Shopping
            </Link>
          </div>
