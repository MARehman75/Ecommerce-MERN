        ...
        <>
            {orders.map((order) => (
                <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h1 className="text-4xl text-left font-bold my-5 pt-3 tracking-tight text-gray-900">Order # {order.id}</h1>
                    <h3 className="text-xl text-left font-bold my-5 pt-3 tracking-tight text-red-700">Order Status: {order.status}</h3>
